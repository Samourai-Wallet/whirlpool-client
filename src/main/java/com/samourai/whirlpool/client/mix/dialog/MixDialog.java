...
public class MixDialog {
  ...
  public MixDialog(
      MixDialogListener listener, StompTransport transport, WhirlpoolClientConfig clientConfig) {
  ...
  private void doRegisterOutput(
    ...
    try {
      String registerOutputUrl =
          WhirlpoolProtocol.computeRegisterOutputUrl(clientConfig.getServer());
